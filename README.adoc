...
include::docs/logo.png["EPP Client",width="200"]
...
* 🚧 `<update>` is used for changes to the details of a domain name.
...
* ✅ `<update>` is used for changes to the details of a name server.
...
* ✅ `<update>` is used for changes to the details of a contact.
