...
* 🚧 `<update>` is used for changes the details of a domain name (including DNSSEC/`secDNS` DS record add and remove; changing a reserved-format domain's registration type is not yet implemented).
